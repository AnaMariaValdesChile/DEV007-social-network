...
const headerImg = "/DEV007-social-network/assets/header.53e54a11.jpg";
...
const Login = (onNavigate2) => {
  ...
  loginDiv.innerHTML += `
  <input type="text" class="inputLogin" id="inputLogin" placeholder="Escribe tu publicaci\xF3n aqu\xED">
  <br>
