...
const style = "";
const fongoHome = "/DEV007-social-network/assets/fongoHome.f94223f0.png";
const doce = "/DEV007-social-network/assets/12.9bc3f27e.png";
const trece = "/DEV007-social-network/assets/13.9b334faf.png";
const ocho = "/DEV007-social-network/assets/8.33649bd6.png";
const siete = "/DEV007-social-network/assets/7.394daf17.png";
/**
 * @license
...
var ta$1 = y("Opera"), z$1 = y("Trident") || y("MSIE"), ua$1 = y("Edge"), va = ua$1 || z$1, wa = y("Gecko") && !(-1 != pa().toLowerCase().indexOf("webkit") && !y("Edge")) && !(y("Trident") || y("MSIE")) && !y("Edge"), xa$1 = -1 != pa().toLowerCase().indexOf("webkit") && !y("Edge");
function ya() {
  var a = l.document;
...
function fb(a, b2, c, d, e) {
  if (Array.isArray(b2))
    ...
    (d = p(d) ? !!d.capture : !!d, c = $a$1(c), a && a[Ha]) ? (a = a.i, b2 = String(b2).toString(), b2 in a.g && (f = a.g[b2], c = Ta(f, c, d, e), -1 < c && (Ka(f[c]), Array.prototype.splice.call(f, c, 1), 0 == f.length && (delete a.g[b2], a.h--)))) : a && (a = bb(a)) && (b2 = a.g[b2.toString()], a = -1, b2 && (a = Ta(b2, c, d, e)), (c = -1 < a ? b2[a] : null) && gb(c));
}
function gb(a) {
...
k$1.lb = function() {
  this.B = null;
  const a = Date.now();
  0 <= a - this.Y ? (Kb(this.j, this.A), 2 != this.L && (Ob(), F$1(17)), I(this), this.o = 2, pc(this)) : wc$1(this, this.Y - a);
};
function pc(a) {
...
function Kc$1(a, b2) {
  if (a.forEach && "function" == typeof a.forEach)
    ...
    for (var c = Jc(a), d = Ic$1(a), e = d.length, f = 0; f < e; f++)
...
function Qc(a, b2, c) {
  b2 instanceof Pc ? (a.i = b2, Xc$1(a.i, a.h)) : (c || (b2 = Sc(b2, Yc$1)), a.i = new Pc(b2, a.h));
}
function K$1(a, b2, c) {
  a.i.set(b2, c);
}
...
var Tc$1 = /[#\/\?@]/g, Vc = /[#\?:]/g, Uc = /[#\?]/g, Yc$1 = /[#\?@]/g, Wc = /#/g;
function Pc(a, b2) {
  this.h = this.g = null;
  this.i = a || null;
  this.j = !!b2;
...
k$1.ib = function() {
  null != this.v && (this.v = null, zc$1(this), Ac(this), F$1(19));
};
function yc$1(a) {
...
function J$1(a, b2) {
  ...
  if (2 == b2) {
    ...
    a.h && (c = null);
    var d = q$1(a.pb, a);
    c || (c = new M$1("//www.google.com/images/cleardot.gif"), l.location && "http" == l.location.protocol || Nc(c, "https"), hc$1(c));
    jd(c.toString(), d);
  } else
    F$1(2);
  a.H = 0;
...
const savedUser = (displayName, email, password, uid) => mf(gh(db, "users", uid), {
  displayName,
  email,
  password,
  uid
...
const Home = (onNavigate2) => {
  ...
  iniciarSesionDiv2.innerHTML = `<h2 id="homeTitle">Iniciar Sesi\xF3n</h2>
  ...
  buttonLogin.addEventListener("click", async () => {
    try {
      ...
      if (errorCode === "auth/wrong-password") {
        homeDiv.querySelector("#iniciarSesionDiv").querySelector("#iniciarSesionDiv2").querySelector("#labelErrors").textContent = "Contrase\xF1a incorrecta";
      }
...
const uno = "/DEV007-social-network/assets/1.c361f905.png";
const Register = (onNavigate2) => {
  ...
  registerDiv.querySelector("#buttonRegister").addEventListener("click", async () => {
    try {
      ...
      await createUser(signUpEmail, signUpPassword).then(async (userCredentials) => {
        ...
        console.log(savedUser(displayName, signUpEmail, signUpPassword, user2.uid));
        return savedUser(displayName, signUpEmail, signUpPassword, user2.uid);
      }).then(() => {
        onNavigate2("/login");
      });
    } catch (error) {
      ...
      if (errorCode === "auth/weak-password") {
        registerDiv.querySelector("#containerFormRegister").querySelector("#labelErrors").textContent = "Tu contrase\xF1a debe contener al menos 6 caracteres";
      }
      if (errorCode === "auth/invalid-email") {
...
const headerImg = "/DEV007-social-network/assets/headers.5ccc8a80.jpg";
const menuImg = "/DEV007-social-network/assets/menu.471630d0.png";
const nueve = "/DEV007-social-network/assets/9.c6f220c4.png";
const Login = (onNavigate2) => {
  ...
  loginDiv.innerHTML += `
  <input type="text" class="inputLogin" id="inputLogin" placeholder="Escribe tu publicaci\xF3n dando click aqu\xED">
  <br>
